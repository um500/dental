// import { Award, GraduationCap, Briefcase, Star, Phone, Users, Heart, Sparkles } from "lucide-react"
...
//       {/* Hero Section */}
//       <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 via-white to-cyan-50">
...
//                 We are a dental practice dedicated to the well-being and happiness of every single individual patient.
...
//                 <div className="bg-gradient-to-br from-yellow-400 via-amber-500 to-orange-500 rounded-2xl shadow-2xl border-4 border-white p-4 transform rotate-6 hover:rotate-0 transition-transform">
...
//               {/* </CHANGE> */}
//               {/* Decorative element */}
//               <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full blur-2xl opacity-50"></div>
//             </div>
//           </div>
//         </div>
//       </section>
...
//               <Card
//                 key={index}
//                 className="p-8 text-center border-2 hover:shadow-xl hover:border-blue-200 transition-all hover:-translate-y-1"
//               >
...
//           <h2 className="text-4xl font-bold text-gray-900 mb-6">Our Treatment Philosophy</h2>
//           <p className="text-xl text-gray-600 mb-4 leading-relaxed text-balance">
...
//         <div className="max-w-4xl mx-auto text-center">
//           <h2 className="text-4xl font-bold mb-6 text-balance">Experience the Future of Dentistry</h2>
